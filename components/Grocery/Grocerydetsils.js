...
const Grocerydetsils = ({navigation, route}) => {
...
await axios.get(`http://3.6.180.23:5000/vendor/vendor/${vendorid}`,
{
    headers:{
...
<View style={{marginTop:20, padding:30, borderRadius:30, borderWidth:1, borderColor:'grey'}}>
<View>
    <Text style={{fontSize:24, fontWeight:'800', color:'#f83758'}}>
        Vendor Details
    </Text>
</View>
...
Vendor name: {vendordetails.name}
    ...
    <Text style={{fontSize:16, fontWeight:'500', color:'#f83758'}}>
...
<View>
    <Text style={{fontSize:16, fontWeight:'500', color:'#f83758'}}>
        {vendordetails.vendorbuisnessname}
    </Text>
</View>
<View>
    <Text style={{fontSize:16, fontWeight:'500', color:'#f83758'}}>
